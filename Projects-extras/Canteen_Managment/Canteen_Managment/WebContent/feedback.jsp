	...
	<div id="main-content">
		...
		<form action="feedback">
			<table class="table2">
                <thead>
                    <tr>
                        <th scope="col" abbr="Complaint ID">Complaint ID</th>
                        <th scope="col" abbr="Name of Student">Name of Student</th>
                        <th scope="col" abbr="Complaint Category">Complaint Category</th>
                        <th scope="col" abbr="Complaint">Complaint</th>
                        <th scope="col" abbr="Is solved?">Is solved?</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <input type="submit" value="Delete these items" style="color: black;font-size: larger;">
            </div>
	</form>
            </div>
		</div> <!-- /.container-fluid -->
