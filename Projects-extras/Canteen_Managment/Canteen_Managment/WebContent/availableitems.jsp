...
<body>
	...
	<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="welcome-text">
							<h2>Currently Available items are...</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<form action="" method="post">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" abbr="Price">Price</th>
                         <th scope="col" abbr="Is Available">Is Available</th>
                    </tr>
                </thead>
                <tbody>
                   ...
                   <tr>
					...
					<td><c:choose>
							<c:when test="${x.isAvailable}">
								<input type="checkbox" disabled="disabled" checked="checked" name="${x.id}" />
							</c:when>
							<c:otherwise>
								<input type="checkbox" disabled="disabled" name="${x.id}" />
							</c:otherwise>
						</c:choose></td>
				</tr>
            ...
            <button  onclick="return redirect('Change Availability')" style="color: red;font-size: larger;">Update Availability</button>
