...
<body>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="welcome-text">
							<h2>Recharge Customer's balance amount...</h2>
						</div>
					</div>
				</div>
			</div>
  ...
  <form action="recharge">
      <input class="textbox" placeholder="Account Number" name="account_number" type="text" required="required"/><br><Br>
		<input class="textbox" placeholder="Amount" name="balance" type="number" min="1" required="required" /> <br>
		<input class="button" type="submit" value="Recharge" /> 
