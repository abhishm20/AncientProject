...
<body>
  ...
  <form action="newuser" method="post">
		<input class="textbox" type="text" required="required" placeholder="Name" name="name"/>
		<input class="textbox" type="password" required="required" placeholder="password" name="password"/>
		<input class="textbox" type="text" required="required" placeholder="Roll No." name="rollno"/>
		<input class="textbox" type="email" required="required"placeholder="Email" name="email"/>
		<input class="textbox" type="text" required="required" placeholder="Phone No." name="phone"/>
		<input class="textbox" type="number" required="required" placeholder="Balance" name="balance" min="1"/>
