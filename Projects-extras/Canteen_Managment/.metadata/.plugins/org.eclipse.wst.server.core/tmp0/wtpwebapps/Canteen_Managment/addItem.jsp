...
<body>
  ...
  <form action="newitem" method="post">
      <input class="textbox" type="text" placeholder="Name of Item" required="required" name="item"/>
		<input class="textbox"  type="number" placeholder="Amount" required="required" name="amount" min="1"/>
