	...
	<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="welcome-text">
							<h2>Select Customers to delete...</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<form action="deletecustomer" method="post">
			<table class="table2">
                <thead>
                    <tr>
                        <th scope="col" abbr="Account Number">Account Number</th>
                        <th scope="col" abbr="Name">Name</th>
                        <th scope="col" abbr="Balance">Balance</th>
            ...
            <input type="submit" value="Delete Customers"  style="color: red;font-size: larger;"/>
            <input type="reset" value="Reset"  style="color: black;font-size: larger;">
            </div>
	</form>
            </div>
		</div> <!-- /.container-fluid -->
