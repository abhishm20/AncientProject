...
<body>
  ...
  <form action="update" method="post">
      <input class="textbox" type="text" value="${id}" placeholder="Id of Item"  readonly="readonly" required="required" name="id"/>
      <input class="textbox" type="text" value="${name}" placeholder="Name of Item" required="required" name="item"/>
      <input class="textbox" type="number" value="${price}" placeholder="Amount" required="required" name="amount" min="1"/>
